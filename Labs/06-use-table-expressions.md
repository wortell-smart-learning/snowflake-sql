...
De volgende module is [Additional exercises: Combine query results with set operators](./07-combine-query-results.md). Hieronder vind je een overzicht van alle modules:
...
7. [Create queries with table expressions](./06-use-table-expressions.md) (huidige module)
