...
De volgende module is [Module 2: Sort and Filter Query Results](../02-filter-sort.md). Hieronder vind je een overzicht van alle modules:

1. [Get Started with Snowflake SQL](../01-get-started-with-snowflake-sql.md) (huidige module)
